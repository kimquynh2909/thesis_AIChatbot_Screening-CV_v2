...
QDRANT_COLLECTION_NAME = os.getenv("QDRANT_COLLECTION_NAME") or os.getenv("QDRANT_COLLECTION") or "resume_rag_chunks"
QDRANT_JOB_COLLECTION_NAME = os.getenv("QDRANT_JOB_COLLECTION_NAME") or os.getenv("QDRANT_JOB_COLLECTION") or "job_description_embeddings"
QDRANT_JOB_EMBEDDING_MODEL = os.getenv("QDRANT_JOB_EMBEDDING_MODEL", DEFAULT_EMBEDDING_MODELS["sbert"])
